...
things=["``I'm the best me I can be.''",
        ...
        "Nick sneers (gives the weird nose wrinklring thingy)",
        ...
        "Candidate uses the third person (but not in the meet the candidates videos)",
        ...
        "Lord Sugar arrives unnanounced into the house",
